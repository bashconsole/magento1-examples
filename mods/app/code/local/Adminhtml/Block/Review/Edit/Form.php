...
class Toppik_Adminhtml_Block_Review_Edit_Form extends Mage_Adminhtml_Block_Widget_Form {
   ...
   /*   $fieldset->addField('yourlocal', 'text', array(
            'label' => Mage::helper('review')->__('Your Local'),
            'required' => true,
            'name' => 'yourlocal'
        ));  */
