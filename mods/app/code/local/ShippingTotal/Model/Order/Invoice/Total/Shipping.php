 ...
 */
class Toppik_Sales_Model_Order_Invoice_Total_Shipping extends Mage_Sales_Model_Order_Invoice_Total_Shipping
{
...
//var_dump(get_class($this)); exit();
        ...
        if ($orderShippingAmount) {
            ...
            $invoice->setGrandTotal($invoice->getGrandTotal()+$shippingInclTax);
            $invoice->setBaseGrandTotal($invoice->getBaseGrandTotal()+$baseShippingInclTax);
        }
        return $this;
    }
}
